...
const About = () => {
  ...
  const programs = [
    { name: "HTML", svgSrc: HTMLLogo },
    { name: "CSS", svgSrc: CSSLogo },
    { name: "JavaScript", svgSrc: JavaScriptLogo },
    { name: "BootStrap", svgSrc: BootStrapLogo },
    { name: "FireBase", svgSrc: FirebaseLogo },
    { name: "React.js", svgSrc: ReactLogo },
    { name: "Node.js", svgSrc: NodeJsLogo },
    { name: "Socket.io", svgSrc: SocketIoLogo },
    { name: "WebRTC", svgSrc: WebRTCLogo },
    { name: "Three.js", svgSrc: ThreeJsLogo },
    {
      name: "Phaser.js",
      svgSrc: () => <img src="/Phaser Logo Web Quality.png" alt="Phaser.js" />,
    },
    { name: "Electron.js", svgSrc: ElectronJsLogo },
    { name: "GitHub", svgSrc: GitHubLogo },
  ];
